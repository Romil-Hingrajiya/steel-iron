...
export default function ExternalPressureReliefValvesPage() {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [isModalOpen, setIsModalOpen] = useState(false);

  const productData = {
    name: 'External Pressure Relief Valves',
    description: 'High-performance external pressure relief valves designed for LPG overpressure protection. Features advanced sealing technology and reliable operation for maximum safety in gas distribution systems.',
    images: [
      '/products/1_external-relief-valves_lpg_nh3.webp',
      '/products/2_external-relief-valves_lpg_nh3.webp',
      '/products/3_external-relief-valves_cap_lpg_nh3.webp'
    ],
    features: [
      'Pressure rated up to 27 bar (391 psi)',
      'External mounting for easy access',
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Technical specifications and features of our External Pressure Relief Valves.
            </p>
          </div>
        ...
        faqs={[
          {
            ...
            answer: 'Our External Pressure Relief Valves are rated up to 27 bar (391 psi), making them suitable for most LPG and NH3 applications. The valves are designed with a safety margin to ensure reliable operation under normal and emergency conditions.'
          },
          {
            id: 'installation',
            question: 'How are these valves installed?',
            answer: 'Installation requires professional expertise. The valves are typically installed externally on LPG storage tanks or equipment using NPT threaded connections. External mounting provides easy access for maintenance and inspection. We recommend having our certified technicians perform the installation to ensure proper setup and compliance with safety standards.'
          },
          {
            id: 'maintenance',
            question: 'What maintenance is required for these valves?',
            answer: 'Regular maintenance includes annual inspections, pressure testing, and cleaning of valve components. The valves feature automatic reseating technology, but periodic checks ensure optimal performance. External mounting makes maintenance easier and more accessible. We offer comprehensive maintenance services and training programs.'
          },
          {
            id: 'certifications',
            question: 'What certifications do these valves have?',
            answer: 'Our External Pressure Relief Valves are UL listed, ASME certified, and comply with CE and PED standards. They meet international safety requirements for gas equipment and are approved for use in industrial and commercial applications.'
          },
          {
            id: 'sizing',
